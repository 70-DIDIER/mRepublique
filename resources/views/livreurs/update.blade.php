...
<div class="container mt-4">
    ...
    <form action="{{ route('livreurs.update', $livreur->id)}}" method="POST" enctype="multipart/form-data" class="shadow p-4 rounded bg-light mx-auto" style="max-width: 600px;">
        @csrf
        @method('PUT')
       ...
       <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="hidden" name="livreur" class="form-control" id="livreur" required>
        </div>
